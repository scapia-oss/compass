...
- **Plain language**: the design must use plain, simple English. Follow `rules/document-style.md`. Flag jargon when a simpler accurate word exists. Define rare technical terms once.
