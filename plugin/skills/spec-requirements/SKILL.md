...
- If `spec_type` is `"bugfix"`: Switch to bugfix analysis mode:
  - Load `templates/specs/bugfix.md` from this skill's directory (repo override: `.kiro/settings/templates/specs/bugfix.md`) for structure (instead of requirements template)
...
- Read `templates/specs/requirements.md` from this skill's directory (repo override: `.kiro/settings/templates/specs/requirements.md`) for document structure
