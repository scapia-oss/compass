...
Use `rules/document-style.md` for writing style. Requirements must use plain, simple English.
...
- The draft must cover the main user journeys, scope boundaries, error cases, and visible edge cases.
- If the feature touches nearby systems, specs, or workflows, say what this feature expects from them and what it does not own.
- Include business rules, compliance, security, privacy, and operations only when they affect visible behavior or operator expectations.
...
- Replace jargon with simple words when the meaning stays the same.
