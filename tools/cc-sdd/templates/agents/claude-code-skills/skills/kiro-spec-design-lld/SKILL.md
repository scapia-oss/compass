...
- `templates/specs/design-lld.md` from this skill's directory (repo override: `{{KIRO_DIR}}/settings/templates/specs/design-lld.md`) for document structure
